...
def generate_launch_description():
    ...
    rockpick_launch_path = os.path.join(pkg_share, 'launch', 'rockpick.launch.py')
    ...
    rockpick_gz_sim = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(rockpick_launch_path),
    ...
    camera_1 = Node(package='rover_description', 
                    executable='rockpick_detection.py', 
                    name='rockpick_front', 
                    parameters=[{
                        'use_sim_time': True,
                    }],output='screen')
    camera_2 = Node(package='rover_description', 
                    executable='rockpick_detection1.py', 
                    name='rockpick_left', 
                    parameters=[{
                        'use_sim_time': True,
                    }],output='screen')
    camera_3 = Node(package='rover_description', 
                    executable='rockpick_detection2.py', 
                    name='rockpick_right', 
                    parameters=[{
                        'use_sim_time': True,
                    }],output='screen')
